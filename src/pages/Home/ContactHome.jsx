...
const ContactHome = () => {
  return (
    <div className="text-white bg-[#0F0F0F] pb-[15%]">
      <a href="/Contact">
      <div className="w-[60%] m-auto lg:w-[30%] p-8">
      ...
      <div className="m-auto lg:w-[25vw] w-[80vw] h-auto p-3 rounded-full border-[3px] border-solid border-spacing-3 hover:border-[#6947ef] contactButton transition-all duration-500">
