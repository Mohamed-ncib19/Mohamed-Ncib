    ...
    return ( 
        <div className=' m-auto bg-[#0F0F0F] p-6'>
            ...
            <div className="w-[80%] m-auto each-slide-effect h-[50vh]">
                <div className='h-[50vh] flex flex-col bg-contain bg-no-repeat bg-center' style={{ 'backgroundImage': `url(${wehiveonFigma})` }}>
                    <div className='bg-[#2a2a2b] shadow-lg w-auto m-auto flex justify-center items-center rounded-full p-4 hover:bg-[#6947ef] transition-all duration-300 '>
                        <a className='text-white m-auto text-[2rem]' target='_blank' rel='noreferrer' href="https://www.figma.com/design/4WGMbbBXOAf5XFY9e02bAd/WeHiveOn?node-id=0-1&t=sbosQ8H8N2EkKtMC-1"><FigmaIcon /></a>
                   </div>
                </div>
