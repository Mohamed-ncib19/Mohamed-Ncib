      ...
      <div className="space-y-14">
        ...
        >
          ...
          >
            <div className="flex flex-row justify-around items-center w-full">
              <p className="text-[20px]">WeHiveOn</p>
                <a
                  ...
                  className="bg-[#6947ef] rounded-md text-white m-auto lg:w-[50%] w-[60%] p-1 text-center hover:bg-[#7355eb] hover:text-[#0F0F0F] transition-all duration-500"
                >
                  Description Doc
                </a>
              <a
            ...
            {showVideo && (
              <button
                className="bg-red-800 hover:bg-opacity-60 px-10 py-2 rounded-md shadow"
          ...
          <div
            id="project"
            className="flex flex-col items-center gap-4 w-[90%] md:w-[70%] md:h-auto h-auto rounded-xl m-auto border border-[#6947ef] p-2 transition-all duration-500"
          >
            <div className="flex flex-row justify-around items-center w-full">
          ...
          <div
            id="project"
            className="flex flex-col items-center gap-4 w-[90%] md:w-[60%] md:h-auto h-auto rounded-xl m-auto border border-[#6947ef] p-2 transition-all duration-500"
          >
            <div className="flex flex-row justify-around items-center w-[100%]">
              <p className="text-[20px]">Icloud-login-clone</p>
                <a
                  href="https://mohamed-ncib19.github.io/Icloud-login-clone/"
                  className="bg-[#6947ef] rounded-md text-white m-auto lg:w-[50%] w-[60%] p-1 text-center hover:bg-[#7355eb] hover:text-[#0F0F0F] transition-all duration-500 cursor-pointer"
                >
                  Live Preview
                </a>
              <a
                href="https://github.com/Mohamed-ncib19/Icloud-login-clone"
                className="bg-[#484848] p-2 rounded-full hover:bg-[#6947ef] hover:text-[#ffffff] transition-all duration-300"
              >
                <GithubIcon />
              </a>
          ...
          <div
            id="project"
            className="flex flex-col items-center justify-center gap-4 w-[90%] md:w-[60%] md:h-auto h-auto rounded-xl m-auto border border-[#6947ef] p-2 transition-all duration-500"
          >
            <div className="flex flex-row justify-around items-center w-[100%]">
              <p className="text-[20px]">nuisible expert</p>
                <a
                  href="https://nuisiblexpert.fr/fr/"
                  className="bg-[#6947ef] rounded-md text-white m-auto lg:w-[50%] w-[60%] p-1 text-center hover:bg-[#7355eb] hover:text-[#0F0F0F] transition-all duration-500 cursor-pointer"
                >
                  Live Preview
                </a>
              <a className="bg-[#484848] p-2 rounded-full hover:bg-[#beb0a4] hover:text-[#ffffff] transition-all duration-300">
                <Wordpress />
              </a>
            </div>
            <div className="w-[100%] m-auto">
