    ...
    return ( 
        ...
        <div className="bg-[#6947ef] w-[40%] h-[20vh] rounded-full blur-3xl m-auto float-right mt-[-8rem] -z-10 lg:w-[22%] transition-all duration-500">
          ...
          <div className=" h-screen flex flex-col justify-center items-center gap-6 text-white text-[40px] -mt-[90px]">
            <h1 className="cursor-pointer hover:text-[#6947ef] transition-all duration-500"><a href="/Portfolio/About-Me">About</a></h1>
            <h1 className="cursor-pointer hover:text-[#6947ef] transition-all duration-500"><a href="/Portfolio/Works">Works</a></h1>
            <h1 className="cursor-pointer hover:text-[#6947ef] transition-all duration-500"><a href="/Portfolio/Contact">Contact</a></h1>
          </div>
          </div>
